        ...
        <div class="d-flex flex-row">
            ...
            <div class="mobile-profile-menu d-none">
                    ...
                    <form class="form">
                        ...
                        <div class="card-body">  
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <input class="form-control form-control-lg form-control-solid" name="commission" type="text" value="{{ $user->commission }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label">Salary</label>
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-header border-0 py-5">
                        <h3 class="card-title remove-flex align-items-start flex-column">
                            <span class="card-label font-weight-bolder text-dark">Employeers</span>
                            <span class="text-muted mt-3 font-weight-bold font-size-sm">Employee Employeers Details</span>
                        </h3>
                        <div class="card-toolbar"> 
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-head-custom table-head-bg table-vertical-center">
                                <thead>
                                    <tr class="bg-gray-100 text-left">
                                        <th style="min-width: 100px" class="pl-7">
                                            <span class="text-dark-75">Employeer</span>
                                        </th>
                                ...
                                <tbody> 
                                    ...
                                    @foreach($employeers as $employeer) 
                                        <tr>
                                            <td>{{ $employeer->employeer }}</td>
                                            <td>
                                                @if($employeer->from !== "") 
                                                    {{ date('d-m-Y', strtotime($employeer->from)) }}
                                                @endif
                                            </td>
                                            <td>
                                                @if($employeer->to !== "") 
                                                    {{ date('d-m-Y', strtotime($employeer->to)) }}
                                                @endif
                                            </td>  
                                        </tr>
                                    @endforeach 
