...
return [
    ...
    // Demo Assets
    'resources' => [
        'favicon' => 'assets/site_identity/favicon-icon.png',
        'fonts' => [
            'google' => [
                'families' => [
        ...
        'css' => [
            ...
            'css/custom.css',
            'plugins/custom/query_builder/query-builder.default.css',
        ],
        'js' => [
            'plugins/global/plugins.bundle.js',
            'plugins/custom/prismjs/prismjs.bundle.js',
            'js/scripts.bundle.js',
            'plugins/custom/jquery_validate/jquery.validate.min.js',
            'plugins/custom/jquery_validate/additional-methods.min.js',
