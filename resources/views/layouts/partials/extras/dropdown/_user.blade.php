...
<div class="navi navi-spacer-x-0 pt-5">
    ...
    <div class="navi-footer  px-8 py-5">
        <a href="{{url('/logout')}}" target="_blank" class="btn btn-light-primary font-weight-bold">Sign Out</a>
        <a href="#" target="_blank" class="btn btn-clean font-weight-bold d-none">Upgrade Plan</a>
    </div>
</div>
